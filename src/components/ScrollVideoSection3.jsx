...
import AnimatedTextCard2 from './AnimatedTextCard2'
...
export default function ScrollVideoSection3() {
  ...
  const [videoKey] = useState('section-3')
          ...
          <div className="relative w-full md:w-[55%] h-[50vh] md:h-full flex-shrink-0 overflow-hidden">
            ...
            {isOwner && (
              <div className="absolute top-8 right-8 z-20">
                <VideoUploader sectionId="section-3" onUploadSuccess={handleVideoUploadSuccess} />
              </div>
            )}
      ...
      <div className="bg-[#020203] px-4 py-12">
        <div className="mx-auto max-w-6xl space-y-6">
          {staticSections.map((section) => (
            <AnimatedTextCard2 key={section.id} data={section} staticMode />
          ))}
        </div>
      </div>
    ) : null}
