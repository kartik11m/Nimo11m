...
export default function ScrollVideoSection2() {
  ...
  const [videoKey] = useState('section-2')
  ...
  return (
    <>
      ...
      >
        ...
        {isMobile ? (
          <div className="w-full flex flex-col md:order-1">
<div className="w-full h-[44vh] sm:h-[48vh] overflow-hidden relative">
            <video
              ...
              playsInline
              preload="auto"
              onLoadedData={() => console.log('Mobile video loaded:', videoUrl)}
              onError={(event) => console.error('Mobile video load error:', videoUrl, event)}
            />
          </div>
          ...
          <div className="relative w-full md:w-[45%] h-full overflow-hidden md:order-1">
        ...
        {/* ════════ RIGHT — Three.js canvas panel ════════ */}
        {!isMobile && (
          <div className="relative w-full md:w-[55%] h-[50vh] md:h-full flex-shrink-0 overflow-hidden md:order-2">
            <video
            ...
            {isOwner && (
              <div className="absolute top-8 right-8 z-20">
                <VideoUploader sectionId="section-2" onUploadSuccess={handleVideoUploadSuccess} />
              </div>
            )}
